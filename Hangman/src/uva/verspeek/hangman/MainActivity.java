...
public class MainActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (newGame != null) {
			...
			randomWord = gamePrefs.getString("word", getWord(wordLength)
					.toUpperCase());
	...
	private int getScore() {
		...
		return (randomWord.length() * unique * positions) / (getMistakes() + 1);
	}
	...
	public void newGame() {
		...
		wordLength = settings.getInt("wordLength", 9);
		randomWord = getWord(wordLength).toUpperCase();
		moves = 0;
	...
	private void setHighScore(String name, int exScore) {
	...
	private void win() {
		...
		alert.setMessage("You made " + getMistakes() + " mistakes.\nScore: "
